 ...
 * @author damian
 */
public class Chr5HamiltonDiameter extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr5HamiltonDiameter instance = null;

	private Chr5HamiltonDiameter() {
		super(1, 1);
	}

	public synchronized static Chr5HamiltonDiameter getInstance() {
		if (instance == null) {
			instance = new Chr5HamiltonDiameter();
		}
		return instance;
	}
