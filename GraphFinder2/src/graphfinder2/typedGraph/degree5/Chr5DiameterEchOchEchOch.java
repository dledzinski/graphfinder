 ...
 * @author damian
 */
public final class Chr5DiameterEchOchEchOch extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr5DiameterEchOchEchOch instance = null;

	private Chr5DiameterEchOchEchOch() {
		super(2, 4);
	}

	public synchronized static Chr5DiameterEchOchEchOch getInstance() {
		if (instance == null) {
			instance = new Chr5DiameterEchOchEchOch();
		}
		return instance;
	}
