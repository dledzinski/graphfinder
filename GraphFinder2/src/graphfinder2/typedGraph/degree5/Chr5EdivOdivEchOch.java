 ...
 * @author damian
 */
public class Chr5EdivOdivEchOch extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr5EdivOdivEchOch instance = null;

	private Chr5EdivOdivEchOch() {
		super(2, 4);
	}

	public synchronized static Chr5EdivOdivEchOch getInstance() {
		if (instance == null) {
			instance = new Chr5EdivOdivEchOch();
		}
		return instance;
	}
