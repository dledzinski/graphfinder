 ...
 * @author damian
 */
public class Chr3Diameter extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr3Diameter instance = null;

	private Chr3Diameter() {
		super(1, 0);
	}

	public synchronized static Chr3Diameter getInstance() {
		if (instance == null) {
			instance = new Chr3Diameter();
		}
		return instance;
	}
