 ...
 * @author damian
 */
public class Chr3Ch1Ch2Ch3 extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr3Ch1Ch2Ch3 instance = null;

	private Chr3Ch1Ch2Ch3() {
		super(3, 3);
	}

	public synchronized static Chr3Ch1Ch2Ch3 getInstance() {
		if (instance == null) {
			instance = new Chr3Ch1Ch2Ch3();
		}
		return instance;
	}
	...
	public boolean isValidParams(int nodeNUmber, int[] params) {
		return RingGraph.isValidChordLength(nodeNUmber, params[0], complexity) && RingGraph.isValidChordLength(nodeNUmber, params[1], complexity) && RingGraph.isValidChordLength(nodeNUmber, params[2], complexity);
	}
