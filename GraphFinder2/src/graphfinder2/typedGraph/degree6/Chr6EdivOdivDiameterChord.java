 ...
 * @author damian
 */
public class Chr6EdivOdivDiameterChord extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr6EdivOdivDiameterChord instance = null;

	private Chr6EdivOdivDiameterChord() {
		super(2, 3);
	}

	public synchronized static Chr6EdivOdivDiameterChord getInstance() {
		if (instance == null) {
			instance = new Chr6EdivOdivDiameterChord();
		}
		return instance;
	}
	...
	public boolean isValidParams(int nodeNumber, int[] params) {
		return RingGraph.isValidDivisibleLength(nodeNumber, params[0], complexity) && RingGraph.isValidDivisibleLength(nodeNumber, params[1], complexity) && RingGraph.isValidChordLength(nodeNumber, params[2], complexity/2);
	}
