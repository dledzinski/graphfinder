 ...
 * @author damian
 */
public class Chr6DivisibleEhamOham extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr6DivisibleEhamOham instance = null;

	private Chr6DivisibleEhamOham() {
		super(2, 3);
	}

	public synchronized static Chr6DivisibleEhamOham getInstance() {
		if (instance == null) {
			instance = new Chr6DivisibleEhamOham();
		}
		return instance;
	}
	...
	public boolean isValidParams(int nodeNumber, int[] params) {
		return RingGraph.isValidDivisibleLength(nodeNumber, params[0], complexity/2) && RingGraph.isValidHamiltonLength(nodeNumber, params[1], complexity) && RingGraph.isValidHamiltonLength(nodeNumber, params[2], complexity);
	}
