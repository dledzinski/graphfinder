 ...
 * @author damian
 */
public class Chr6HamoltonChordChord extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr6HamoltonChordChord instance = null;

	private Chr6HamoltonChordChord() {
		super(1, 3);
	}

	public synchronized static Chr6HamoltonChordChord getInstance() {
		if (instance == null) {
			instance = new Chr6HamoltonChordChord();
		}
		return instance;
	}
	...
	public boolean isValidParams(int nodeNumber, int[] params) {
		return params[0] != params[1] && params[0] != params[2] && params[1] != params[2] && RingGraph.isValidHamiltonLength(nodeNumber, params[0], complexity) && RingGraph.isValidChordLength(nodeNumber, params[1], complexity) && RingGraph.isValidChordLength(nodeNumber, params[2], complexity);
	}
