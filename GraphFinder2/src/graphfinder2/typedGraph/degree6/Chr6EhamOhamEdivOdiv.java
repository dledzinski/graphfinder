 ...
 * @author damian
 */
public class Chr6EhamOhamEdivOdiv extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr6EhamOhamEdivOdiv instance = null;

	private Chr6EhamOhamEdivOdiv() {
		super(2, 4);
	}

	public synchronized static Chr6EhamOhamEdivOdiv getInstance() {
		if (instance == null) {
			instance = new Chr6EhamOhamEdivOdiv();
		}
		return instance;
	}
	...
	public boolean isValidParams(int nodeNumber, int[] params) {
		return params[0] != params[2] && params[1] != params[3] && RingGraph.isValidHamiltonLength(nodeNumber, params[0], complexity) && RingGraph.isValidHamiltonLength(nodeNumber, params[1], complexity) && RingGraph.isValidDivisibleLength(nodeNumber, params[2], complexity) && RingGraph.isValidDivisibleLength(nodeNumber, params[3], complexity);
	}
