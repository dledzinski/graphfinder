 ...
 * @author damian
 */
public class Chr6DivisibleDiameterChord extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr6DivisibleDiameterChord instance = null;

	private Chr6DivisibleDiameterChord() {
		super(1, 2);
	}

	public synchronized static Chr6DivisibleDiameterChord getInstance() {
		if (instance == null) {
			instance = new Chr6DivisibleDiameterChord();
		}
		return instance;
	}
	...
	public boolean isValidParams(int nodeNumber, int[] params) {
		return params[0] != params[1] && RingGraph.isValidDivisibleLength(nodeNumber, params[0], complexity) && RingGraph.isValidChordLength(nodeNumber, params[1], complexity);
	}
