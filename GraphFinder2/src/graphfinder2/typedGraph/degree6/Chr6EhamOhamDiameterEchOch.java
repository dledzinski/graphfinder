 ...
 * @author damian
 */
public class Chr6EhamOhamDiameterEchOch extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr6EhamOhamDiameterEchOch instance = null;

	private Chr6EhamOhamDiameterEchOch() {
		super(2, 4);
	}

	public synchronized static Chr6EhamOhamDiameterEchOch getInstance() {
		if (instance == null) {
			instance = new Chr6EhamOhamDiameterEchOch();
		}
		return instance;
	}
