 ...
 * @author damian
 */
public class Chr6DivisibleEdivOdiv extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr6DivisibleEdivOdiv instance = null;

	private Chr6DivisibleEdivOdiv() {
		super(2, 3);
	}

	public synchronized static Chr6DivisibleEdivOdiv getInstance() {
		if (instance == null) {
			instance = new Chr6DivisibleEdivOdiv();
		}
		return instance;
	}
	...
	public boolean isValidParams(int nodeNumber, int[] params) {
		return RingGraph.isValidDivisibleLength(nodeNumber, params[0], complexity/2) && RingGraph.isValidDivisibleLength(nodeNumber, params[1], complexity) && RingGraph.isValidDivisibleLength(nodeNumber, params[2], complexity);
	}
