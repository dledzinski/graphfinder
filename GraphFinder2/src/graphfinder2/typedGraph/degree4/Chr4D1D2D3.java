 ...
 * @author damian
 */
public class Chr4D1D2D3 extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr4D1D2D3 instance = null;

	private Chr4D1D2D3() {
		super(3, 3);
	}

	public synchronized static Chr4D1D2D3 getInstance() {
		if (instance == null) {
			instance = new Chr4D1D2D3();
		}
		return instance;
	}
	...
	public boolean isValidParams(int nodeNumber, int[] params) {
		return RingGraph.isValidDivisibleLength(nodeNumber, params[0], complexity) && RingGraph.isValidDivisibleLength(nodeNumber, params[1], complexity) && RingGraph.isValidDivisibleLength(nodeNumber, params[2], complexity);
	}
