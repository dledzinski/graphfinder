 ...
 * @author damian
 */
public class Chr4EdivOdiv extends AbstractTypedGraphCreator {

	// jedyny obiekt
	private static Chr4EdivOdiv instance = null;

	private Chr4EdivOdiv() {
		super(2, 2);
	}

	public synchronized static Chr4EdivOdiv getInstance() {
		if (instance == null) {
			instance = new Chr4EdivOdiv();
		}
		return instance;
	}
